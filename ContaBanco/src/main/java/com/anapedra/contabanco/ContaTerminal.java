...
public class ContaTerminal implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Account account = new Account();
                ...
                System.out.println("Abertura de conta  Santander");
                ...
                account.deposit(sc.nextBigDecimal());

                System.out.println("A sua conta está apta para uso. Obrigada pela preferencia!\n" +
                        "Seu um saldo de: " + account.getBalance()+ "disponível para saque.");
